...
<head>
    ...
    <link href="{{asset('tema/Main Files/HTML/default/assets/css/lib/chartist/chartist.min.css')}}" rel="stylesheet">
    <link href="{{asset('tema/Main Files/HTML/default/assets/css/lib/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{asset('tema/Main Files/HTML/default/assets/css/lib/themify-icons.css')}}" rel="stylesheet">
    <link href="{{asset('tema/Main Files/HTML/default/assets/css/lib/owl.carousel.min.css')}}" rel="stylesheet" />
    <link href="{{asset('tema/Main Files/HTML/default/assets/css/lib/owl.theme.default.min.css')}}" rel="stylesheet" />
    <link href="{{asset('tema/Main Files/HTML/default/assets/css/lib/weather-icons.css')}}" rel="stylesheet" />
    <link href="{{asset('tema/Main Files/HTML/default/assets/css/lib/menubar/sidebar.css')}}" rel="stylesheet">
    <link href="{{asset('tema/Main Files/HTML/default/assets/css/lib/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('tema/Main Files/HTML/default/assets/css/lib/unix.css')}}" rel="stylesheet">
    <link href="{{asset('tema/Main Files/HTML/default/assets/css/style.css')}}" rel="stylesheet">
</head>
...
<body>
    ...
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/lib/jquery.min.js')}}"></script>
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/lib/jquery.nanoscroller.min.js')}}"></script>
    <!-- nano scroller -->
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/lib/menubar/sidebar.js')}}"></script>
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/lib/preloader/pace.min.js')}}"></script>
    <!-- sidebar -->
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/lib/bootstrap.min.js')}}"></script>
    <!-- bootstrap -->
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/lib/weather/jquery.simpleWeather.min.js')}}"></script>
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/lib/weather/weather-init.js')}}"></script>
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/lib/circle-progress/circle-progress.min.js')}}"></script>
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/lib/circle-progress/circle-progress-init.js')}}"></script>
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/lib/chartist/chartist.min.js')}}"></script>
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/lib/chartist/chartist-init.js')}}"></script>
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/lib/sparklinechart/jquery.sparkline.min.js')}}"></script>
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/lib/sparklinechart/sparkline.init.js')}}"></script>
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/lib/owl-carousel/owl.carousel.min.js')}}"></script>
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/lib/owl-carousel/owl.carousel-init.js')}}"></script>
    <script src="{{asset('tema/Main Files/HTML/default/assets/js/scripts.js')}}"></script>
